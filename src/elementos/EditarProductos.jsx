...
function EditarProductos() {
  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      ...
      const respuesta = await fetch(`https://68dad96c23ebc87faa316b2d.mockapi.io/api/productos/${producto.id}`, {
        method: 'PUT',
      ...
      <form onSubmit={manejarEnvio}>
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '8px', marginTop: '5px', border: `5px solid ${errores.precio ? 'red' : '#ccc'}` }}
          />
