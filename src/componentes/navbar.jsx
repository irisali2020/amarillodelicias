    ...
    <>
      <NavbarContainer className="navbar navbar-expand-lg navbar-dark fixed-top">
        <div className="container-fluid">
          <Logo to="/" className="navbar-brand">Amarillo Delicias</Logo>
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <NavLink to="/ListaProductos" className="nav-link">Productos</NavLink>
              </li>
              <li className="nav-item">
            ...
            <SeccionUsuario className="d-flex align-items-center gap-3">
              ...
              {isAuthenticated ? (
                ...
                <NavLink to="/IniciarSesion" className="nav-link">Iniciar Sesión</NavLink>
              )}
            </SeccionUsuario>
          </div>
        </div>
...
const NavbarContainer = styled.nav`
  background-color: #b110a9ff !important;
  padding: 0.5rem 1rem;
`;
